    ...
    return {
      ...
      details: [
        ...
        <ul>
          ...
          <li>Real Analysis (MA 34100) — Analysis of real numbers (up to calculus)</li>
          <li>Applied Algorithms (ECE 59500) — Survey of various algorithms and their applications</li>
        </ul>`,

        `<p>If you share a passion for technology or the outdoors, I'd love to connect. Feel free to <a href='/contact'>reach out!</a> Let's talk coding, climbing, or anything in between!</p>`
      ]
    }
  }
})
...
button:hover {
  background-color: var(--accent-color-2); /* Slightly lighter green on hover */
  color: white;
